...
const es: SiteContent = {
  ...
  projects: [
    ...
    { id:"lego-london", title:"Lego London HUB offices with BDG", location:"London", thumbnail:"/images/projects/al-ameen/hero.jpg", type:"Oficinas / Workplace", status:"En desarrollo", inDevelopment:true, heroImage:"/images/projects/al-ameen/hero.jpg", shortDesc:"", longDesc:[], labor:[], images:[] },
    { id:"holbein-gardens", title:"Holbein Gardens offices with BDG", location:"London", thumbnail:"/images/projects/al-ameen/hero.jpg", type:"Oficinas / Workplace", status:"En desarrollo", inDevelopment:true, heroImage:"/images/projects/al-ameen/hero.jpg", shortDesc:"", longDesc:[], labor:[], images:[] },
    { id:"andaz-turks", title:"Andaz Turks & Caicos at Grace Bay with Modus Operandi Inc", location:"Turks and Caicos Islands", thumbnail:"/images/projects/al-ameen/hero.jpg", type:"Hotel", status:"En desarrollo", inDevelopment:true, heroImage:"/images/projects/al-ameen/hero.jpg", shortDesc:"", longDesc:[], labor:[], images:[] },
    { id:"sant-feliu", title:"Sant Feliu de Guíxols residential with Africa Lao", location:"Girona, Spain", thumbnail:"/images/projects/al-ameen/hero.jpg", type:"Residencial", status:"En desarrollo", inDevelopment:true, heroImage:"/images/projects/al-ameen/hero.jpg", shortDesc:"", longDesc:[], labor:[], images:[] },
  ],
