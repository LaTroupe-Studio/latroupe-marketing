...
const es: SiteContent = {
  ...
  projects: [
    ...
    { id:"sant-feliu", title:"Sant Feliu de Guíxols |\nResidential Renovation", location:"Girona, Spain", thumbnail:"/images/projects/sant-feliu/hero.jpg", type:"Residencial", status:"En desarrollo", inDevelopment:true, heroImage:"/images/projects/sant-feliu/hero.jpg", shortDesc:"", longDesc:[], labor:[], images:[] },
    { id:"holbein-gardens", title:"Holbein Gardens |\nCorporate Offices", location:"Londres, Reino Unido", thumbnail:"/images/projects/holbein-gardens/hero.jpg", type:"Oficinas / Workplace", status:"En desarrollo", inDevelopment:true, heroImage:"/images/projects/holbein-gardens/hero.jpg", shortDesc:"", longDesc:[], labor:[], images:[] },
    { id:"andaz-turks", title:"Andaz Turks & Caicos at Grace Bay |\nHotel Renovation", location:"Turks and Caicos Islands", thumbnail:"/images/projects/andaz-turks/hero.jpg", type:"Hotel", status:"En desarrollo", inDevelopment:true, heroImage:"/images/projects/andaz-turks/hero.jpg", shortDesc:"", longDesc:[], labor:[], images:[] },
  ],
