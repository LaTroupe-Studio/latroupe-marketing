...
const en: SiteContent = {
  ...
  hero: { prefix:"latroupe", rotatingWords:["designs","technifies","organises","improves","optimises","executes","builds","anticipates"], suffix:"behind the scenes", description:"We expand the capabilities of architecture and interior design studios supporting them throughout every phase of a project.", srHeading:"LaTroupe Studio · technical support for architecture and interior design studios" },
