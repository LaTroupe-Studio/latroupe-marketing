...
const baseContent: SiteContent = {
  ...
  bim: {
    ...
    hero: { h1: "", subhead: "", cta: { label: "", id: "" }, ctaSub: "" },
    trustBand: { eyebrow: "", tagline: "" },
    services: { eyebrow: "", headline: "", sub: "", items: [] },
    deliverables: { eyebrow: "", headline: "", sub: "", items: [] },
    adapts: { headline: "", sub: "", items: [] },
    riba: { eyebrow: "", headline: "", caption: "", stages: [] },
    standards: { eyebrow: "", headline: "", sub: "", items: [] },
    sectors: { eyebrow: "", headline: "", items: [], sub: "" },
    why: { eyebrow: "", headline: "", items: [] },
    tools: { eyebrow: "", headline: "", sub: "", items: [] },
    caseStudy: { eyebrow: "", headline: "", heroImage: "", location: "", year: "", area: "", typology: "", author: "", endClient: "", intro: "", standards: "", whatWeDid: [], result: "", imageCredit: "" },
    faq: { eyebrow: "", headline: "", items: [] },
    header: { popup: { whoLabel: "", namePlaceholder: "", reachLabel: "", emailPlaceholder: "", projectLabel: "", projectPlaceholder: "", moreLabel: "", morePlaceholder: "", submit: "", legal: "", legalLinkPhrase: "", legalLinkHref: "", closeAriaLabel: "" } },
    ctaSection: { headline: "", sub: "", fields: { whoLabel: "", namePlaceholder: "", reachLabel: "", emailPlaceholder: "", projectLabel: "", projectPlaceholder: "", moreLabel: "", morePlaceholder: "", submit: "", sending: "", sent: "", error: "" }, legal: "", legalLinkPhrase: "", legalLinkHref: "" },
  },
};
