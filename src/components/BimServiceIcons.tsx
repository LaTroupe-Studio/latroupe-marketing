...
export const serviceIcons = [
  // I) BIM Modelling (Revit)
  (
    <svg key="modelling" className={styles.svcIcon} viewBox="0 0 360 300" aria-hidden="true">
      <polygon points="180,50 280,105 180,160 80,105" fill="#AC6752" className={styles.faceTop} />
      <polygon points="80,105 180,160 180,250 80,195" fill="#AC6752" />
      <polygon points="180,160 280,105 280,195 180,250" fill="#AC6752" />
      <g stroke="#28170E" strokeWidth={1.4} fill="none" strokeLinejoin="miter" strokeLinecap="square">
  ...
  // II) BIM Content Creation
  (
    <svg key="content" className={styles.svcIcon} viewBox="0 0 360 300" aria-hidden="true">
      <rect x="51" y="67" width="74" height="74" fill="#AC6752" className={styles.iconGrid} />
      <g stroke="#28170E" strokeWidth={1.4} fill="none" strokeLinejoin="miter" strokeLinecap="square">
  ...
  // III) BIM Management & Information Management
  (
    <svg key="management" className={styles.svcIcon} viewBox="0 0 360 300" aria-hidden="true">
      <g stroke="#28170E" strokeWidth={1.4} fill="none" strokeLinejoin="miter" strokeLinecap="square">
        <g strokeDasharray="6 6" className={styles.marchIn}>
  ...
  // IV) BIM Execution Plan (BEP)
  (
    <svg key="bep" className={styles.svcIcon} viewBox="0 0 360 300" aria-hidden="true">
      <g stroke="#28170E" strokeWidth={1.4} fill="none" strokeLinejoin="miter" strokeLinecap="square">
      ...
      <circle cx="130" cy="110" r="9" fill="#AC6752" stroke="#28170E" strokeWidth={1.4} className={styles.step} />
    </svg>
  ),
  // V) BIM Coordination & Clash Detection
  (
    <svg key="coordination" className={styles.svcIcon} viewBox="0 0 360 300" aria-hidden="true">
      <g stroke="#28170E" strokeWidth={1.4} fill="none" strokeLinejoin="miter" strokeLinecap="square">
  ...
  // VI) Embedded BIM Support
  (
    <svg key="embedded" className={styles.svcIcon} viewBox="0 0 360 300" aria-hidden="true">
      <g stroke="#28170E" strokeWidth={1.4} fill="none" strokeLinejoin="miter" strokeLinecap="square">
        ...
        <circle cx="108" cy="96" r="13" fill="#AC6752" stroke="none" className={styles.mem1} />
        <circle cx="252" cy="96" r="13" fill="#AC6752" stroke="none" className={styles.mem2} />
        <circle cx="252" cy="204" r="13" fill="#AC6752" stroke="none" className={styles.mem3} />
        <circle cx="108" cy="204" r="13" fill="#AC6752" stroke="none" className={styles.mem4} />
        <circle cx="180" cy="150" r="22" fill="#AC6752" />
      </g>
    </svg>
  ),
  // VII) BIM Project & Data Management Consultancy
  (
    <svg key="data" className={styles.svcIcon} viewBox="0 0 360 300" aria-hidden="true">
      <g stroke="#28170E" strokeWidth={1.4} fill="none" strokeLinejoin="miter" strokeLinecap="square">
        ...
        <line x1="46" y1="150" x2="314" y2="150" strokeDasharray="8 8" className={styles.march} />
      ...
      <g fill="#AC6752" stroke="none">
        <circle cx="150" cy="126" r="3.4" className={styles.flow} style={{ animationDelay: "0s" }} />
        <circle cx="180" cy="126" r="3.4" className={styles.flow} style={{ animationDelay: "0.8s" }} />
        <circle cx="210" cy="126" r="3.4" className={styles.flow} style={{ animationDelay: "1.6s" }} />
      </g>
    </svg>
  ),
];
